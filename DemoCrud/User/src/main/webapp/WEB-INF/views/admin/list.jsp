...
<c:url var="formUrl" value="/admin/home" />
				...
				<div class="col-lg-12">
					<div class="main-box clearfix">
						<div class="table-responsive">
                            ...
                            <button type="button" id="btnAdd" onclick="window.location.href='<c:url value="/admin/add" />'" class="btn btn-info">Add</button>
                             <button type="button" id="btnDrag" onclick="window.location.href='<c:url value="/admin/drop-drag" />'" class="btn btn-info">DropDrag</button>
								...
								<tbody id="tbody">
									...
									<c:forEach items="${model.listResult}" var="items">
										<tr>
											...
											<td style="width: 20%;"><a href='<c:url value="/admin/edit/${items.id}"/>' id="btnEdit" class="table-link btnEdit">
													<span class="fa-stack"> <i
														class="fa fa-square fa-stack-2x"></i> <i
														class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
												</span>
											</a> <a href="#" class="table-link" disabled="disabled"> <span class="fa-stack">
														<i class="fa fa-square fa-stack-2x"></i> <i
														class="fa fa-pencil fa-stack-1x fa-inverse"></i>
												</span>
											</a> <a href="#" class="table-link danger btnDelete" style="color: black"> <span
													class="fa-stack"> <i
														class="fa fa-square fa-stack-2x"></i> <i
