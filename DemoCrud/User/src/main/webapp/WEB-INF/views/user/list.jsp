				...
				<div class="col-lg-12">
					<div class="main-box clearfix">
						<div class="table-responsive">
                            ...
                            <button type="button" id="btnAdd" onclick="window.location.href='<c:url value="/add" />'" class="btn btn-info">Add</button>
								...
								<tbody id="tbody">
									...
									<c:forEach items="${model.listResult}" var="items">
										<tr>
											...
											<td style="width: 20%;"><a href='<c:url value="/edit/${items.id}"/>' id="btnEdit" class="table-link btnEdit">
